    ...
    if (val != '') {
        ...
        request.onload = function() {
            if (request.status >= 200 && request.status < 400) {
                ...
                console.log(we);
                document.getElementById('weather').innerHTML = 'Name : ' + we.name + "<br><br>" + 'Temperature : ' + parseFloat(we.main.temp-273.15 ).toFixed(2)+ ' °C' + "<br><br>" + 'Humidity : ' + we.main.humidity + "<br><br>" + 'Pressure : ' + we.main.pressure;
